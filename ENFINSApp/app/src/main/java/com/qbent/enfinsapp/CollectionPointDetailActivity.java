...
public class CollectionPointDetailActivity extends MainActivity implements ApiCallback {
    ...
    private String gramPanchayetId = " ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blockSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                int a = indexes.indexOf(name);
                gramPanchayetId = (new ArrayList<String>(spinnerBlocksMap.keySet())).get(indexes.indexOf(name));
                populateGramPanchayets(gramPanchayetId);
    ...
    //-----Developed by Debmalya-----//
    private void populateGramPanchayets(String gramPanchayetId) {
        new ApiHandler.GetAsync(CollectionPointDetailActivity.this).execute("panchayats-by-block/{"+ gramPanchayetId +"}");
    }
